...
Secondly, make sure that \code{ExpandNodeList} is %and makedepf90 are 
in the local \code{bin} folder. 
(The utility \code{ExpandNodeList} is used to expand and collect node lists as used by SLURM, in order to perform set operations on them.)
